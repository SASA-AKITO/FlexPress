...
pub struct CliOpts {
    ...
    #[arg(short, long, default_value = "flexpress.zip", value_name = "OUTPUT", required = false,
    ...
    auto mode: if the arguments have archive files, it will extract them. Otherwise, it will archive the
    files.")]
